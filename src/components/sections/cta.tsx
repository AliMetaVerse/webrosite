  ...
  return (
    <section className="bg-surface py-20 lg:py-28">
      <div className="container-x">
        <div className="brand-surface relative overflow-hidden rounded-card px-6 py-16 text-center sm:px-12 lg:py-20">
          <div className="bg-grid deco absolute inset-0 opacity-30 [mask-image:radial-gradient(ellipse_at_center,black,transparent_75%)]" />
          <div
            className="deco absolute -right-10 -top-10 h-48 w-48 rounded-full bg-white/10 blur-3xl"
            aria-hidden
          />
          <div className="relative mx-auto max-w-2xl">
            ...
            <ul className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-2">
              {points.map((p) => (
                ...
                >
                  <CheckIcon className="text-base text-white/80" />
                  {p}
                </li>
              ))}
            </ul>
